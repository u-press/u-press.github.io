...
<head>
  ...
  <!-- =======================================================
    Theme Name: BizPAge
    Theme URL: https://bootstrapmade.com/-bootstrap-business-template/
...
Como parte del curso Fundamentos de Biodiseño, estamos encargados de diseñar y prototipar un dispositivo que permita la íntegra recuperación de pacientes que han sufrido de quemaduras de segundo y tercer grado a nivel facial.</p>
          ...
          <div class="carousel-item">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                ...
                <p>Existen distintos métodos para tratar la cicatrización de las quemaduras tanto quirúrgicos, con tópicos o medicina regenerativa; no obstante, hasta ahora no hay un tratamiento que sea mejore la integridad estético-funcional del paciente sin comprometer su seguridad. La presoterapia parece ser una solución efectiva, económica y poco invasiva, sin embargo, su principal problema de la presoterapia radica en la presión aplicada en el rostro  que por defecto también es aplicada a zonas de la cara que no la requieren, lo cuál genera dolor innecesario y molestias por parte de los usuarios.</p>
  ...
  <main id="main">
    ...
    <!--==========================
      Cortado .Featured Services Section
    ============================-->
   
   <!--==========================
     Cortado Team Section
    ============================-->
    ...
    <section id="team">
      <div class="container">
        <div class="section-header wow fadeInUp">
         ...
         <p> Como parte del curso Fundamentos de Biodiseño, estamos encargados de diseñar y prototipar un dispositivo que permita la íntegra recuperación de pacientes que han sufrido de quemaduras de segundo y tercer grado a nivel facial.</p>
        </div>
<center>
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
            ...
            <div class="member">
              ...
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Rafael Torres</h4>
                  <span>Coordinador de Diseño</span>
                  <div class="social">
                    <a href=""><i class="fa fa-twitter"></i></a>
                    <a href=""><i class="fa fa-facebook"></i></a>
                    <a href=""><i class="fa fa-google-plus"></i></a>
    ...
    <!--==========================
      cortado About Us Section
    ============================-->
  

    <!--==========================
      Cortado Services Section
    ============================-->
    

    <!--==========================
     cortado  Call To Action Section
    ============================-->
  

    <!--==========================
     Cortado  Skills Section
    ============================-->
    ...
    <section id="facts"  class="wow fadeIn">
      <div class="container">
        ...
        <header class="section-header">
          <h3>Estadísticas</h3>
          <p>Aún si no hay estadísticas concretas en el Perú, la incidencia de los datos de morbilidad y mortalidad por quemaduras son alarmantes..</p>
        </header>
        ...
        <div class="row counters">
          ...
          <div class="col-lg-3 col-6 text-center">
            <span data-toggle="counter-up">265.000</span>
            <p>Casos de fallecimiento anualmente por quemaduras a nivel mundial </p>
  				</div>

          <div class="col-lg-3 col-6 text-center">
            <span data-toggle="counter-up">78.25</span>
            <p>Porcentaje de quemaduras por líquidos calientes en Perú de acuerdo al total (Estimado)</p>
  				</div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app wow fadeInUp">
            <div class="portfolio-wrap">
              <figure>
                ...
                <a href="semana1.html" class="link-details" title="More Details"><i class="ion ion-android-open"></i></a>
              </figure>

              <div class="portfolio-info">
                <h4><a href="semana1.html">Semana 1</a></h4>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web wow fadeInUp" data-wow-delay="0.1s">
            <div class="portfolio-wrap">
              <figure>
                ...
                <a href="semana2.html" class="link-details" title="More Details"><i class="ion ion-android-open"></i></a>
              </figure>

              <div class="portfolio-info">
                <h4><a href="semana2.html">Semana 2</a></h4>
                <p>Estado del arte</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app wow fadeInUp" data-wow-delay="0.2s">
            <div class="portfolio-wrap">
              <figure>
                ...
                <a href="semana3.html" class="link-details" title="More Details"><i class="ion ion-android-open"></i></a>
              </figure>

              <div class="portfolio-info">
                <h4><a href="semana3.html">Semana 3</a></h4>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card wow fadeInUp">
            <div class="portfolio-wrap">
              <figure>
                ...
                <a href="semana4.html" class="link-details" title="More Details"><i class="ion ion-android-open"></i></a>
              </figure>

              <div class="portfolio-info">
                <h4><a href="semana4.html">Semana 4</a></h4>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web wow fadeInUp" data-wow-delay="0.1s">
            <div class="portfolio-wrap">
              <figure>
                ...
                <a href="semana5.html" class="link-details" title="More Details"><i class="ion ion-android-open"></i></a>
              </figure>

              <div class="portfolio-info">
                <h4><a href="semana5.html">Semana 5</a></h4>
                <p>Diagrama de Gantt y Tabla de Valoración</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app wow fadeInUp" data-wow-delay="0.2s">
            <div class="portfolio-wrap">
              <figure>
                ...
                <a href="semana6.html" class="link-details" title="More Details"><i class="ion ion-android-open"></i></a>
              </figure>

              <div class="portfolio-info">
                <h4><a href="semana6.html">Semana 6</a></h4>
                <p>App</p>
              </div>
            </div>
          </div>
    ...
    <!--==========================
     Cortado Clients Section
    ============================-->
   

    <!--==========================
      Cortado Testimonials Section
    ============================-->
        ...
        <div class="row contact-info">
          ...
          <div class="col-md-4">
            <div class="contact-address">
              ...
              <h3>Dirección</h3>
              <address>Av. Universitaria 1801, San Miguel</address>
            </div>
          </div>
